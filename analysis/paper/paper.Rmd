...
email_survey %>%
  ...
  scale_fill_manual(values = wes_palette("Rushmore")[c(1,3)], 
                    guide = FALSE) +
...
file_type_location %>%
  ...
  geom_point(aes(size = n),
             colour = wes_palette("Rushmore")[c(2)],
             shape = 16) +
  theme_bw() +
  xlab("") +
  ylab("") +
...
ggplot(aes(reorder(Var1, n),
           n)) +
  geom_col(fill = wes_palette("Rushmore")[4]) +
  coord_flip() +
  xlab("Data centre") +
  ylab("") +
  theme_new() +
...
ggplot(aes(occurred_at)) +
  geom_histogram(fill = wes_palette("Rushmore")[4]) +
