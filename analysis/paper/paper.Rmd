...
```{r fig.cap="Summary of results of email requests for data"}
...
```{r  fig.cap="Summary of relationships between file types, data types, and data locations"}
