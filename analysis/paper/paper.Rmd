...
knitr::kable(tbl, caption = "Summary of a selection of previous studies of data sharing in various fields.")
```
...
knitr::include_graphics("plot_structured_data_files_per_file_tally.png")
```
